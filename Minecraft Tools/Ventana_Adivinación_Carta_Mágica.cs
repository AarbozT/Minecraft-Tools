...
{
    public partial class Ventana_Adivinación_Carta_Mágica : Form
    {
        public Ventana_Adivinación_Carta_Mágica()
        {
            InitializeComponent();
        }

        internal readonly string Texto_Título = "Magic Card Guessing for " + Program.Texto_Usuario + " by Jupisoft";
        ...
        private void Ventana_Adivinación_Carta_Mágica_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Program.Matriz_Cartas_79 == null && Directory.Exists(Program.Ruta_Cartas_79))
                {
                    ...
                    for (int Índice = 0; Índice < 79; Índice++)
                    {
                        try
                        {
                        ...
                        catch (Exception Excepción) { Depurador.Escribir_Excepción(Excepción != null ? Excepción.ToString() : null); Variable_Excepción_Total++; Variable_Excepción = true; Program.Matriz_Cartas_79[Índice] = new Bitmap(224, 400, PixelFormat.Format24bppRgb); continue; }
                    }
                }
        ...
        private void Ventana_Adivinación_Carta_Mágica_Shown(object sender, EventArgs e)
        {
            try
            {
                this.Activate();
        ...
        private void Ventana_Adivinación_Carta_Mágica_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
        ...
        private void Ventana_Adivinación_Carta_Mágica_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
        ...
        private void Ventana_Adivinación_Carta_Mágica_SizeChanged(object sender, EventArgs e)
        {
            try
            {
        ...
        private void Ventana_Adivinación_Carta_Mágica_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
