...
namespace Minecraft_Tools
{
    public partial class Ventana_Afinador_Bloques_Nota : Form
    {
        ...
        internal readonly string Texto_Título = "Note Blocks Tuner for " + Program.Texto_Usuario + " by Jupisoft";
        ...
        internal static byte[][] Matrices_Bytes_WAV = new byte[13][]
        {
            Sonidos_Bloques_Nota.Obtener_Matriz_Bytes(0),
            Sonidos_Bloques_Nota.Obtener_Matriz_Bytes(1),
            Sonidos_Bloques_Nota.Obtener_Matriz_Bytes(2),
            Sonidos_Bloques_Nota.Obtener_Matriz_Bytes(3),
            Sonidos_Bloques_Nota.Obtener_Matriz_Bytes(4),
            Sonidos_Bloques_Nota.Obtener_Matriz_Bytes(5),
            Sonidos_Bloques_Nota.Obtener_Matriz_Bytes(6),
            Sonidos_Bloques_Nota.Obtener_Matriz_Bytes(7),
            Sonidos_Bloques_Nota.Obtener_Matriz_Bytes(8),
            Sonidos_Bloques_Nota.Obtener_Matriz_Bytes(9),
            Sonidos_Bloques_Nota.Obtener_Matriz_Bytes(10),
            Sonidos_Bloques_Nota.Obtener_Matriz_Bytes(11),
            Sonidos_Bloques_Nota.Obtener_Matriz_Bytes(12)
        };
                ...
                if (!e.Alt && !e.Control && !e.Shift)
                {
                    ...
                    else if (e.KeyCode == Keys.Insert)
                    {
                        ...
                        if ((Milisegundo - Milisegundo_Anterior) >= 100) // Only allow 10 plays per second in redstone ticks.
                        {
                            ...
                            Reproductor = Reproductor_Sonidos.Cargar_Sonido(Matrices_Bytes_WAV[Índice_Instrumento], Matriz_Porcentajes_Frecuencias[Matriz_ComboBoxes[Índice_Instrumento].SelectedIndex]);
