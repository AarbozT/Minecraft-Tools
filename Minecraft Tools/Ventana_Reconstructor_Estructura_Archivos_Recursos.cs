...
namespace Minecraft_Tools
{
    public partial class Ventana_Reconstructor_Estructura_Archivos_Recursos: Form
    {
        ...
        internal readonly string Texto_Título = "Resource Files Structure Rebuilder for " + Program.Texto_Usuario + " by Jupisoft";
        ...
        internal static string Ruta_Recursos = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\.minecraft\\assets";
        ...
        private void Ventana_Reconstructor_Estructura_Archivos_Recursos_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                Ocupado = true;
                TextBox_Ruta.Text = Ruta_Recursos;
        ...
        private void TextBox_Ruta_TextChanged(object sender, EventArgs e)
        {
            try
            {
                Ruta_Recursos = TextBox_Ruta.Text;
            }
            catch (Exception Excepción) { Depurador.Escribir_Excepción(Excepción != null ? Excepción.ToString() : null); Variable_Excepción_Total++; Variable_Excepción = true; }
        }
