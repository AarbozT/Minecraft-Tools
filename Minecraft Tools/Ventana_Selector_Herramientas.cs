    ...
    public partial class Ventana_Selector_Herramientas : Form
    {
        ...
        internal struct Herramientas
        {
            ...
            internal static readonly Herramientas[] Matriz_Herramientas = new Herramientas[]
            {
                ...
                new Herramientas("Automatic skin downloader", Resources.Ordenar, Estados.Inoperativo, false, Grupo_Minecraft, typeof(Ventana_Descargador_Skins_Automático), "Tool capable of bulk downloading millions of Minecraft skins from real player names using the desired charset to generate names by order.", new DateTime(2018, 3, 17)),
                ...
                new Herramientas("Banner and shield designer", Resources.minecraft_red_banner, Estados.Funcional, false, Grupo_Minecraft, typeof(Ventana_Diseñador_Estandartes_Escudos), "Tool capable of generating custom banner and shield designs, either for survival or creative mode, with image exporter that includes the full recipe, it also supports loading the recipe images.", new DateTime(2018, 3, 17)),
                ...
                new Herramientas("Block selector", Resources.minecraft_stone, Estados.Funcional, false, Grupo_Minecraft, typeof(Ventana_Selector_Bloques), "Tool capable of selecting Minecraft blocks.", new DateTime(2018, 3, 17)),
                ...
                new Herramientas("Change the username", Resources.Usuario, Estados.Funcional, false, Grupo_Jupisoft, typeof(Ventana_Nombre_Usuario), "Tool capable of changing your user name inside this application, which is only used to say hello to you any time you start it.", new DateTime(2018, 3, 17)),
                ...
                new Herramientas("Custom light level resource packs generator [Optifine]", Resources.Visión_Nocturna, Estados.Funcional, false, Grupo_Minecraft, typeof(Ventana_Generador_Packs_Recursos_Nivel_Luz), "Tool capable of generating new modular resource packs than can give you an infinite night (or blind) vision effect without particles or coloring the screen with your custom colors.", new DateTime(2019, 3, 26)),
                ...
                new Herramientas("Donations received", Resources.Agregar, Estados.Funcional, false, Grupo_Jupisoft, typeof(Ventana_Donaciones), "Tool capable of showing the donations received by Jupisoft. Thanks a lot for all the donations and support.", new DateTime(2018, 10, 11)),
                ...
                new Herramientas("Pixel art generator with world exporter", Resources.Pixel_Art, Estados.Funcional, false, Grupo_Universal, typeof(Ventana_Generador_Pixel_Art), "Tool capable of generating a new 1.12.2- Minecraft world with any selected image inside, but replacing any pixel with a similar Minecraft block.", new DateTime(2018, 3, 17)),
                ...
                new Herramientas("Real time screen filters", Resources.Pantalla, Estados.Funcional, true, Grupo_Universal, typeof(Ventana_Filtros_Pantalla_Tiempo_Real), "Tool capable of filtering the screen in real time, with dozens of exclusive filters (even for video) and also with custom zoom levels.", new DateTime(2019, 1, 21)),
                new Herramientas("Realistic 2D world viewer", Resources.Visor_Mundos_2D, Estados.Funcional, false, Grupo_Minecraft, typeof(Ventana_Visor_Mundos_Realista_2D), "Tool capable of generating a 2D image from the top of any Minecraft world, with dozens of custom maps like block search, caves, ores, structures and slime chunks icons, etc.", new DateTime(2018, 3, 17)),
                new Herramientas("Recipe viewer", Resources.Menú_Contextual, Estados.Intermedio, false, Grupo_Minecraft, typeof(Ventana_Visor_Recetas), "Tool capable of showing a full list of the available crafting, smelting, etc, recipes in Minecraft.", new DateTime(2018, 3, 17)),
