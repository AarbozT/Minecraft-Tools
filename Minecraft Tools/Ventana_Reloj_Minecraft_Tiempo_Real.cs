...
namespace Minecraft_Tools
{
    public partial class Ventana_Reloj_Minecraft_Tiempo_Real : Form
    {
        ...
        internal readonly string Texto_Título = "Real Time Minecraft Clock for " + Program.Texto_Usuario + " by Jupisoft";
            ...
            try
            {
                if (!Ocupado)
                {
                    ...
                    if (Variable_Dibujar_Tierra_Sol_Luna)
                    {
                        ...
                        Imagen_Sol = Program.Obtener_Imagen_Miniatura(Imagen_Sol, Ancho_Alto_Tierra_Sol_Luna * 2, Ancho_Alto_Tierra_Sol_Luna * 2, true, false);
                        ...
                        Barra_Estado_Etiqueta_Fase_Lunar.Image = Program.Obtener_Imagen_Miniatura(Imagen_Luna, 16, 16, true, false);
                        ...
                        Imagen_Luna = Program.Obtener_Imagen_Miniatura(Imagen_Luna, Ancho_Alto_Tierra_Sol_Luna, Ancho_Alto_Tierra_Sol_Luna, true, false);
                        ...
                        Imagen_Tierra = Program.Obtener_Imagen_Miniatura(Imagen_Tierra, Ancho_Alto_Tierra_Sol_Luna * 2, Ancho_Alto_Tierra_Sol_Luna * 2, true, false);
                        //Pintar.DrawImage(Imagen_Luna, new RectangleF((float)(-16d * Multiplicador_Sol_Luna), (float)(-16d * Multiplicador_Sol_Luna), (float)(32d * Multiplicador_Sol_Luna), (float)(32d * Multiplicador_Sol_Luna)), new RectangleF(0f, 0f, 32f, 32f), GraphicsUnit.Pixel);
        ...
        private void Actualizar_Clima()
        {
            try
            {
                if (Variable_Clima == Climas.Automatic)
                {
                    ...
                    if (Variable_Clima_Automático == Climas.Clear) Barra_Estado_Etiqueta_Clima.Image = Program.Obtener_Imagen_Miniatura(Resources.Sol.Clone(new Rectangle(12, 12, 8, 8), PixelFormat.Format32bppArgb), 16, 16, true, false);
                ...
                {
                    if (Variable_Clima == Climas.Clear) Barra_Estado_Etiqueta_Clima.Image = Program.Obtener_Imagen_Miniatura(Resources.Sol.Clone(new Rectangle(12, 12, 8, 8), PixelFormat.Format32bppArgb), 16, 16, true, false);
