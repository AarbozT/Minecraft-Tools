...
namespace Minecraft_Tools
{
    public partial class Ventana_Visor_Mundos_Realista_2D : Form
    {
        ...
        internal static readonly string Texto_Título = "Realistic World Viewer in 2D for Xisumavoid by Jupisoft";
        ...
        private void Ventana_Visor_Mundos_Tiempo_Real_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                Picture.BackgroundImage = new Bitmap(Math.Max(Picture.ClientSize.Width, 1), Math.Max(Picture.ClientSize.Height, 1), PixelFormat.Format32bppArgb);
        ...
        private void Menú_Contextual_Restablecer_Ajustes_Click(object sender, EventArgs e)
        {
            try
            {
                if (MessageBox.Show(this, "Do you want to restore all this settings to it's default values?", Program.Texto_Título_Versión, MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question) == DialogResult.Yes)
                {
        ...
        private void Temporizador_Principal_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(Ruta_Nivel) && Picture.BackgroundImage != null)
                {
                    if (!Subproceso_Activo)
                    {
                        if (Pintar != null)
                                ...
                                for (int Índice_Chunk_X = 0; Índice_Chunk_X < 32; Índice_Chunk_X++)
                                {
                                    if (Región.Matriz_Chunks[Índice_Chunk_X, Índice_Chunk_Z].Matriz_Bytes_IDs != null)
                                    {
                                        ...
                                        for (int Índice_Bloque_Z = 0; Índice_Bloque_Z < 16; Índice_Bloque_Z++)
                                        {
                                            ...
                                            {
                                                for (int Índice_Bloque_Y = 255; Índice_Bloque_Y >= 0; Índice_Bloque_Y--)
                                                {
