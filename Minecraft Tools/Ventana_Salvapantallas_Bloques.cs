...
namespace Minecraft_Tools
{
    public partial class Ventana_Salvapantallas_Bloques : Form
    {
        ...
        internal readonly string Texto_Título = "Blocks Screen Saver for " + Program.Texto_Usuario + " by Jupisoft";
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (Imagen_Recurso != null)
                    {
                        ...
                        double Zoom = Variable_Dimensiones != -1 ? Variable_Dimensiones : (1d + (Program.Rand.NextDouble() * 7d));
                        ...
                        Pintar.DrawImage(Imagen_Recurso, Rectángulo_Zoom, new RectangleF(0f, 0f, (float)Ancho, (float)Alto), GraphicsUnit.Pixel);
        ...
        private void Menú_Contextual_Instalar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                catch (UnauthorizedAccessException Excepción)
                {
                    ...
                    MessageBox.Show(this, "The application saved the screen saver and it's 2 libraries to your desktop, but it couldn't move them to your System32 folder due to a lack of privileges. Please move the files \"Jupisoft - Minecraft Tools.scr\", \"Magick.NET-Q16-AnyCPU.dll\" and \"SevenZipSharp.dll\" manually to \"" + Ruta_System32 + "\".", Program.Texto_Título_Versión, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
                Temporizador_Principal_Tick(Temporizador_Principal, EventArgs.Empty);
                Temporizador_Principal.Start();
            }
