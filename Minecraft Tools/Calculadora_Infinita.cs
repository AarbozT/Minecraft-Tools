...
namespace Minecraft_Tools
{
    internal static class Calculadora_Infinita
    {
        ...
        internal static List<List<int>> Operación_Convertir_a_Base(List<int> Lista_1, List<int> Lista_2)
        {
            List<List<int>> Lista_Números = new List<List<int>>();
            if (Lista_1.Count > 0 && Lista_2.Count > 0 && Operación_Es_Cero(Lista_1) == false && Operación_Obtener_Mayor(Lista_2, new List<int>(new int[] { 1 })) < 0)
            {
                if (Operación_Obtener_Mayor(Lista_2, new List<int>(new int[] { 1, 0 })) != 0)
                {
                    ...
                    {
                        Lista_Cociente = Operación_División(Lista_Cociente, Lista_2, out Lista_Resto);
        ...
        internal static List<int> Operación_Convertir_desde_Base(List<List<int>> Lista_1, List<int> Lista_2)
        {
            List<int> Lista_Números = new List<int>(new int[] { 0 });
            if (Lista_1.Count > 0 && Lista_2.Count > 0 && Operación_Obtener_Mayor(Lista_2, new List<int>(new int[] { 1 })) < 0)
            {
                for (int Índice = Lista_1.Count - 1, Exponente = 0; Índice >= 0; Índice--, Exponente++)
                {
                    if (!Operación_Es_Cero(Lista_1[Índice])) Lista_Números = Operación_Suma(Lista_Números, Operación_Multiplicación(Lista_1[Índice], Operación_Potencia(Lista_2, Traducir_Número(Exponente.ToString()))));
