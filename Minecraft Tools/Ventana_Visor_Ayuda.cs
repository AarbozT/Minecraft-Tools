...
namespace Minecraft_Tools
{
    public partial class Ventana_Visor_Ayuda : Form
    {
        ...
        internal readonly string Texto_Título = "Help Viewer for " + Program.Texto_Usuario + " by Jupisoft";
