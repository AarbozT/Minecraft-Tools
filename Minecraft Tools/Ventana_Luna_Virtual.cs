...
namespace Minecraft_Tools
{
    public partial class Ventana_Luna_Virtual : Form
    {
        ...
        internal readonly string Texto_Título = "Virtual Moon for " + Program.Texto_Usuario + " by Jupisoft";
        ...
        internal static Pen Lápiz = new Pen(Color.FromArgb(192, 0, 0, 0));
        internal static SolidBrush Pincel = new SolidBrush(Color.FromArgb(192, 0, 0, 0));
        ...
        private void Ventana_Luna_Virtual_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                /*for (int Índice = 0; Índice < Astronomía.Matriz_Eclipses_Lunares.Length - 1; Índice++) Combo_Eclipses.Items.Add(Program.Traducir_Fecha(Astronomía.Matriz_Eclipses_Lunares[Índice].Key, true, false, false) + ", " + Astronomía.Matriz_Eclipses_Lunares[Índice].Value + "");
                for (int Índice = 0; Índice < Astronomía.Matriz_Fases_Lunares.Length - 1; Índice++) Combo_Fases.Items.Add(Program.Traducir_Fecha(Astronomía.Matriz_Fases_Lunares[Índice], true, false, false) + ", " + Traducir_Fase(Índice) + "");
                Combo_Modo.Items[2] += " - [" + Program.Traducir_Número((Astronomía.Matriz_Eclipses_Lunares.Length - 1).ToString()) + (Astronomía.Matriz_Eclipses_Lunares.Length == 1 ? " Eclipse]" : " Eclipses]");
                Combo_Modo.Items[3] += " - [" + Program.Traducir_Número((Astronomía.Matriz_Fases_Lunares.Length - 1).ToString()) + (Astronomía.Matriz_Fases_Lunares.Length == 1 ? " Fase]" : " Fases]");
