...
namespace Minecraft_Tools
{
    public partial class Ventana_Información_Miembros_Hermitcraft : Form
    {
        ...
        internal readonly string Texto_Título = "Hermitcraft Members Information for " + Program.Texto_Usuario + " by Jupisoft";
        ...
        private void Ventana_Hermitcraft_Información_Miembros_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                try { TextBox_Biografía.Font = new Font("Calibri", 10f); }
                catch { }
        ...
        private void ComboBox_Hermit_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ComboBox_Hermit.SelectedIndex > -1)
                {
                    ...
                    Picture_Hermit_256.Image = Program.Obtener_Imagen_Miniatura(Program.Obtener_Imagen_Recursos("Hermitcraft_" + Hermit.Lista_Perfiles_Minecraft[0]), 256, 256, true, false);
                    Picture_Fotografía.Image = Program.Obtener_Imagen_Miniatura(Program.Obtener_Imagen_Recursos("Hermitcraft_Picture_" + Hermitcraft.Hermits.Matriz_Hermits[ComboBox_Hermit.SelectedIndex].Lista_Perfiles_Minecraft[0]), Picture_Fotografía.ClientSize.Width, Picture_Fotografía.ClientSize.Height, true, true);
        ...
        private void ComboBox_Perfiles_Minecraft_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (ComboBox_Perfiles_Minecraft.SelectedIndex > -1)
                {
                    ...
                    Picture_Skin.Image = Program.Obtener_Imagen_Miniatura(Program.Obtener_Imagen_Recursos("Hermitcraft_Skin_" + Hermitcraft.Hermits.Matriz_Hermits[ComboBox_Hermit.SelectedIndex].Lista_Perfiles_Minecraft[ComboBox_Perfiles_Minecraft.SelectedIndex]), 256, 256, true, false);
                }
                else
                {
                    Picture_Hermit_256.Image = Resources.Cancelar;
