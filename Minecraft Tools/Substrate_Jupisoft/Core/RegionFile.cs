...
using System.IO;
using Ionic.Zlib;
using Minecraft_Tools;

namespace Substrate_Jupisoft.Core
{
    public class RegionFile : IDisposable
    {
        ...
        public RegionFile(string path)
        {
            ...
            // Acceder como Sólo Lectura, garantizando que no se modificará nada en la carpeta:
            //file = new FileStream(fileName, FileMode.OpenOrCreate, FileAccess.Read, FileShare.ReadWrite);
            ReadFile();
        }
