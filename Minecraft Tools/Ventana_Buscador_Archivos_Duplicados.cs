...
namespace Minecraft_Tools
{
    public partial class Ventana_Buscador_Archivos_Duplicados : Form
    {
        ...
        internal readonly string Texto_Título = "Duplicated Files Finder for " + Program.Texto_Usuario + " by Jupisoft";
        ...
        private void Ventana_Buscador_Archivos_Duplicados_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                Lector = new FileStream(Application.StartupPath + "\\" + Program.Obtener_Nombre_Temporal() + ".txt", FileMode.OpenOrCreate, FileAccess.ReadWrite, FileShare.ReadWrite);
