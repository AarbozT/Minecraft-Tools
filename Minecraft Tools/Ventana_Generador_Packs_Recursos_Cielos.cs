...
namespace Minecraft_Tools
{
    public partial class Ventana_Generador_Packs_Recursos_Cielos : Form
    {
        ...
        internal readonly string Texto_Título = "Sky Box Resource Packs Generator for " + Program.Texto_Usuario + " by Jupisoft";
        ...
        internal Bitmap Variable_Imagen_Textura_Izquierda = null;
        internal Bitmap Variable_Imagen_Textura_Derecha = null;
        internal Bitmap Variable_Imagen_Textura_Abajo = null;
        internal Bitmap Variable_Imagen_Textura_Arriba = null;
        internal Bitmap Variable_Imagen_Textura_Atrás = null;
        internal Bitmap Variable_Imagen_Textura_Delante = null;
        ...
        private void Ventana_Generador_Packs_Recursos_Cielos_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                ComboBox_Exportar_X.SelectedIndex = 2;
                ComboBox_Exportar_Y.SelectedIndex = 1;
            }
        ...
        private void Menú_Contextual_Descargar_Texturas_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Picture_Textura_Izquierda.Image = null;
                Picture_Textura_Derecha.Image = null;
                Picture_Textura_Abajo.Image = null;
                Picture_Textura_Arriba.Image = null;
                Picture_Textura_Atrás.Image = null;
                Picture_Textura_Delante.Image = null;
                ...
                {
                    Variable_Imagen_Textura_Izquierda.Dispose();
                    Variable_Imagen_Textura_Izquierda = null;
                }
                if (Variable_Imagen_Textura_Derecha != null)
                {
                    Variable_Imagen_Textura_Derecha.Dispose();
                    Variable_Imagen_Textura_Derecha = null;
                }
                if (Variable_Imagen_Textura_Abajo != null)
                {
                    Variable_Imagen_Textura_Abajo.Dispose();
                    Variable_Imagen_Textura_Abajo = null;
                }
                if (Variable_Imagen_Textura_Arriba != null)
                {
                    Variable_Imagen_Textura_Arriba.Dispose();
                    Variable_Imagen_Textura_Arriba = null;
                }
                if (Variable_Imagen_Textura_Atrás != null)
                {
                    Variable_Imagen_Textura_Atrás.Dispose();
                    Variable_Imagen_Textura_Atrás = null;
                }
                if (Variable_Imagen_Textura_Delante != null)
                {
                    Variable_Imagen_Textura_Delante.Dispose();
                    Variable_Imagen_Textura_Delante = null;
                }
