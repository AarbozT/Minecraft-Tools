...
{
    public partial class Ventana_Depurador : Form
    {
        public Ventana_Depurador()
        {
            InitializeComponent();
        }
        ...
        private void Ventana_Depurador_Load(object sender, EventArgs e)
        {
        ...
        private void Ventana_Depurador_Shown(object sender, EventArgs e)
        {
            Ocupado = true;
        ...
        private void Ventana_Depurador_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void Ventana_Depurador_FormClosed(object sender, FormClosedEventArgs e)
        {

        }

        private void Ventana_Depurador_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        internal void Cargar_Errores()
        {
                ...
                if (!Ocupado)
                {
                    ...
                    if (Lector_Depurador != null && Lector_Depurador_Binario != null && Lector_Depurador.Length > 0L)
                    {
                        ...
                        if (Lista_Excepciones.Count > 0)
                        {
                            ...
                            {
                                Texto += "[" + (Índice + 1).ToString() + "] [x" + Program.Traducir_Número(Lista_Excepciones[Índice].Repeticiones) + /*"] [CRC-32: " + Program.Traducir_Número(Lista_Excepciones[Índice].CRC32) + */"] [" + Program.Traducir_Fecha(Lista_Excepciones[Índice].Primera_Fecha) + "] [" + Program.Traducir_Fecha(Lista_Excepciones[Índice].Última_Fecha) + "] " + Lista_Excepciones[Índice].Mensaje + "\r\n\r\n";
                            }
                        }
                    }
                    this.Text = "Internal Debugger by Jupisoft - [Errors: " + Program.Traducir_Número(Depurador_Errores) + ", Unique Errors: " + Program.Traducir_Número(Depurador_Errores_Únicos) + "]";
            ...
            catch (Exception Excepción) { MessageBox.Show(this, Excepción.ToString(), "Reproductor Multimedia de Jupisoft", MessageBoxButtons.OK, MessageBoxIcon.Error); }
        }
    }
}
