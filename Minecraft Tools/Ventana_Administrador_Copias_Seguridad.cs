...
{
    public partial class Ventana_Administrador_Copias_Seguridad : Form
    {
        public Ventana_Administrador_Copias_Seguridad()
        {
            InitializeComponent();
        }
        ...
        internal readonly string Texto_Título = "Backups Manager for " + Program.Texto_Usuario + " by Jupisoft";
        ...
        private void Ventana_Administrador_Copias_Seguridad_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //ICSharpCode.SharpZipLib.Zip.ZipFile.Create(); // This library will be used.
            }
            catch (Exception Excepción) { Depurador.Escribir_Excepción(Excepción != null ? Excepción.ToString() : null); }
        }

        private void Ventana_Administrador_Copias_Seguridad_Shown(object sender, EventArgs e)
        {
            try
            {
                this.Activate();
        ...
        private void Ventana_Administrador_Copias_Seguridad_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
        ...
        private void Ventana_Administrador_Copias_Seguridad_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
        ...
        private void Ventana_Administrador_Copias_Seguridad_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
